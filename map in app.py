...
def show_map():
    df = pd.read_csv("D:\\PYTHON\\Final project\\Sorted data.csv")
    fig = px.scatter_geo(
        df,
        locations="Country",
        locationmode="country names",
        hover_name="Name",
        title="Filtered Data by Country",
    ...
    map_path = "D:\\PYTHON\\Final project\\map.html"
...
def save():
    ...
    if filtered.empty:
        ...
        output_path = "D:\\PYTHON\\Final project\\Sorted data.csv"
